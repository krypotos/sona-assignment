defmodule Roster.Accounts.User do
  ...
  alias Roster.Scheduling.{WorkType, WorkerAvailability, Shift}
  ...
  schema "users" do
    ...
    has_one :worker_availability, WorkerAvailability
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Roster.Repo)
  ...
  """
  def valid_password?(%Roster.Accounts.User{hashed_password: hashed_password}, password)
