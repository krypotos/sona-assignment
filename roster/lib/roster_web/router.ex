defmodule RosterWeb.Router do
  ...
  import RosterWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {RosterWeb.Layouts, :root}
  ...
  if Application.compile_env(:roster, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: RosterWeb.Telemetry
  ...
  scope "/", RosterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{RosterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", RosterWeb do
    ...
    live_session :current_user,
      on_mount: [{RosterWeb.UserAuth, :mount_current_user}] do
