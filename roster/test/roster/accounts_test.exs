defmodule Roster.AccountsTest do
  ...
  alias Roster.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "validates email uniqueness" do
      ...
      {:error, changeset} = Accounts.register_user(%{email: email, role: "manager"})
    ...
    test "registers users with worker role" do
      email = unique_user_email()
      {:ok, user} = Accounts.register_user(valid_user_attributes(email: email, role: "worker"))
      assert user.email == email
